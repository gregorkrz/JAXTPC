...
-----
  ...
  python scripts/launch_2d_landscape_pairs.py --dry-run

  # Dry run with all inner commands printed
  python scripts/launch_2d_landscape_pairs.py --dry-run --verbose

  # Submit (default: 15 tracks × 28 pairs = 420 jobs)
  python scripts/launch_2d_landscape_pairs.py

  # Fewer params
  python scripts/launch_2d_landscape_pairs.py --params velocity_cm_us lifetime_us recomb_alpha

  # Custom tracks from YAML
  python scripts/launch_2d_landscape_pairs.py --tracks-yaml my_tracks.yaml

  # Override Slurm settings per run
  python scripts/launch_2d_landscape_pairs.py --account neutrino --partition ampere

/sdf/home/g/gregork/envs/base_env/bin/python scripts/launch_2d_landscape_pairs.py --gradients --dry-run
...
# Repo layout
# ──────────────────────────────────────────────────────────────────────────────
_LANDSCAPE_PY = 'scripts/2d_loss_landscape.py'  # relative to REMOTE_DIR
